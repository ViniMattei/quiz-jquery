// variavel de controle do nosso jogo
...
const perguntas = [
  ...
  {
    pergunta:
      "Qual dessas linguagens não e considerada uma linguagem de programação?",
    respostas: ["PHP", "Javascript", "C++", "HTML"],
    correta: "resp3",
  },
  // pergunta 1
  {
    pergunta: "Qual linguangem e a mais famosa da atualidade?",
    respostas: ["JavaScript", "python", "Java", "TypeScript"],
    correta: "resp0",
  },
  // pergunta 2
  {
    ...
    respostas: [
      "Hyper Text Maluco Legal",
      "Hyper Text Markup Language",
      "Hyper Text More Languange",
  ...
  // pergunta 3
  {
    pergunta: "Quais dessa linguagens serve para estilizar?",
    respostas: ["Javascript", "HTML", "CSS", "Bootstrap"],
    correta: "resp2",
  },
]
